...
export default function CalendarioReserva({ rutaId }) {
    ...
    const CustomToolbar = (toolbar) => {
        const goToToday = () => {
            console.log('CustomToolbar: goToToday');
            toolbar.onNavigate('TODAY');
        };

        const goToBack = () => {
            console.log('CustomToolbar: goToBack');
            toolbar.onNavigate('PREV');
        };

        const goToNext = () => {
            console.log('CustomToolbar: goToNext');
    ...
    useEffect(() => {
        const obtenerActividades = async () => {
            try {
                console.log('useEffect: obtenerActividades');
                ...
                console.log('useEffect: actividades obtenidas', actividadesLista);
            } catch (error) {
                console.error('useEffect: Error al obtener actividades', error);
            }
        };
    ...
    const handleSelectEvent = (event) => {
        ...
        console.log('handleSelectEvent: evento seleccionado', event);
    };

    const handleReservar = async () => {
        if (selectedEvent) {
            try {
                console.log('handleReservar: reservando actividad', selectedEvent.id);
                ...
                console.log('handleReservar: reserva exitosa');
            } catch (error) {
                console.error('handleReservar: Error al reservar', error);
            }
        }
    };
